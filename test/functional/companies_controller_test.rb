...
class CompaniesControllerTest < ActionController::TestCase
  ...
  test "should create company" do
    assert_difference('Company.count') do
      post :create, company: { company_name: @company.company_name, cover_image_url: @company.cover_image_url, established_at: @company.established_at, hompage_url: @company.hompage_url, logo_url: @company.logo_url, number_of_members: @company.number_of_members, slideshare_url: @company.slideshare_url, twitter_id: @company.twitter_id, vine_url: @company.vine_url }
    end
